...
// Exposed so plugins/update.js can gracefully free the port before spawning
// a replacement process on self-update (avoids an EADDRINUSE race between
// the old and new process), and re-bind it if the new process fails to
// start.
global.__popkidServer = server;
global.__popkidPort = PORT;
